...
`````json
{
  ...
  "ui": {
    ...
    "targetPlaceholder": "Ziel (z. B. 10 Min., bis braun)",
  ...
  "workstations": {
    ...
    "bowl": "Zubereitung 🥣",
    "burner": "Kochbereich 🍳",
    "burner1": "Kochbereich 1 🍳",
    "burner2": "Kochbereich 2 🍳",
  ...
  "recipes": {
    "concebolla": {
      ...
      "instructions": [
        ...
        "Schäle die Zwiebeln.",
        "Wasche die Zwiebeln.",
        "Würfele die Zwiebeln.",
        "Erhitze das Olivenöl.",
        "Brate die Kartoffeln an, bis sie weich sind.",
        "Brate die Zwiebeln goldbraun an.",
        "Verquirle die Eier.",
        "Gib Salz und Pfeffer hinzu.",
        "Mische die gebratenen Kartoffeln und Zwiebeln mit den verquirlten Eiern, Salz und Pfeffer.",
        "Gieße die Mischung in die Pfanne.",
        "Koche alles für 5 Minuten.",
        "Achte mit einem weichen Pfannenwender darauf, dass die Tortilla nicht festklebt.",
        "Wende die Tortilla.",
        "Koche sie für weitere 5 Minuten.",
    ...
    "clasica": {
      ...
      "instructions": [
        ...
        "Erhitze das Olivenöl.",
        "Brate den Knoblauch kurz an.",
        "Nimm den Knoblauch auf den Teller.",
        "Brate die Kartoffeln an, bis sie weich sind.",
        "Verquirle die Eier.",
        "Mische Kartoffeln, Eier, Salz, schwarzen Pfeffer und Knoblauch.",
        "Gieße die Mischung in die Pfanne und koche sie 5 Minuten lang.",
        "Achte mit einem weichen Pfannenwender darauf, dass die Tortilla nicht festklebt.",
        "Wende die Tortilla.",
        "Koche sie für weitere 5 Minuten.",
        "Serviere die Tortilla.",
...
`````json
{
  ...
  "ui": {
    ...
    "targetPlaceholder": "Target (e.g. 10 min, until brown)",
    "finalNamePlaceholder": "Final name (e.g. Oma tortilla)",
  ...
  "workstations": {
    ...
    "bowl": "Preparation 🥣",
    "burner": "Cooking Heat 🍳",
    "burner1": "Cooking Heat 1 🍳",
    "burner2": "Cooking Heat 2 🍳",
    "plate": "Serving Stage 🍽️",
    "despensa": "Pantry 🧺",
    "default": "Workstation 📦"
  },
  "verbs": {
  ...
  "recipes": {
    ...
    "clasica": {
      ...
      "instructions": [
        ...
        "Fry the potatoes until tender.",
        "Beat the eggs.",
        "Mix potatoes, eggs, salt, black pepper and garlic.",
        "Pour mixture into the pan and cook for 5 minutes.",
        "With a soft spatula, make sure the tortilla does not stick to the pan.",
        "Flip the tortilla.",
        "Cook for another 5 minutes.",
        "Serve the tortilla.",
...
`````json
{
  ...
  "ui": {
    ...
    "targetPlaceholder": "Objetivo (ej. 10 min, hasta dorar)",
  ...
  "workstations": {
    ...
    "board": "Área de Corte 🔪",
    "bowl": "Preparación 🥣",
    "burner": "Zona de Cocinado 🍳",
    "burner1": "Zona de Cocinado 1 🍳",
    "burner2": "Zona de Cocinado 2 🍳",
    "plate": "Plato de Servir 🍽️",
    "despensa": "Despensa 🧺",
  ...
  "recipes": {
    "concebolla": {
      ...
      "instructions": [
        ...
        "Pela las cebollas.",
        "Lava las cebollas.",
        "Corta las cebollas en dados.",
        "Calienta el aceite de oliva.",
        "Fríe las patatas hasta que estén tiernas.",
        "Fríe las cebollas hasta que estén doradas.",
        "Bate los huevos.",
        "Añade sal y pimienta.",
        "Mezcla las patatas y cebollas fritas con los huevos batidos, sal y pimienta.",
    ...
    "clasica": {
      ...
      "instructions": [
        "Pela los ajos.",
        "Calienta el aceite de oliva.",
        "Fríe los ajos suavemente.",
        "Retira los ajos al plato.",
        "Fríe las patatas hasta que estén tiernas.",
        "Bate los huevos.",
        "Mezcla las patatas, huevos, sal, pimienta negra y ajos.",
        "Vierte la mezcla en la sartén y cocina durante 5 minutos.",
        "Con una espátula blanda, asegúrate de que la tortilla no se pega a la sartén.",
        "Dale la vuelta a la tortilla.",
        "Cocina durante otros 5 minutos.",
        "Sirve la tortilla.",
...
.container-view__actions {
  ...
  .container-view__input {
    ...
    &:focus {
      border-color: $tortilla-yellow;
      box-shadow: 0 0 0 2px rgba(245, 180, 50, 0.2);
    }
...
.scene {
  ...
  @media (max-width: 600px) {
    // 2-column compact layout on very small screens (mobile)
